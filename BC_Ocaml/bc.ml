...
evalStatement (q:envQueue) (s: statement): envQueue =
  ...
  | PrintNewLine(x) -> print_newline(); q
  | If(e, codeT, codeF) -> 
...
(* Below this Comment is where to place testing code *)

(* erase this print statement *)
print_endline "No tests were inserted, manipulate bc.ml, read the _read_me"
;;
